...
public class SymptomsDisplay  {
	...
	private void initialize() {
		...
		lblPersonalInformation.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		lblPersonalInformation.setBounds(278, 6, 130, 16);
		...
		lblCheckAllThat.setBounds(265, 241, 88, 16);
