...
public class connectionSuccess1 {
	...
	void testConnectionSuccess() {
		assertEquals(true, testCountryAPIConnection("Italy"));
		System.out.println("************************************************************");
		System.out.println("Description: This test will pass if connection with the API is successful");
		System.out.println("Green LIGHT: Connection Successful");
		System.out.println("************************************************************");
	}
