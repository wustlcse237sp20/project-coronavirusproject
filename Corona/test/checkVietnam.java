...
public class checkVietnam {
	...
	public String testConnectionVietnam(String country) {
		try {
			...
			return parseJsonVietnam(responseContent.toString());
	...
	public static String parseJsonVietnam(String responseBody) {
	...
	@Test
	public void testUpperCaseVietnam() {
		
		String getS = testConnectionVietnam("vietnam");
		String getR = testConnectionVietnam("vietnam");
		System.out.println("************************************************************");
	...
	@Test
	public void testlowerCaseVietnam() {
