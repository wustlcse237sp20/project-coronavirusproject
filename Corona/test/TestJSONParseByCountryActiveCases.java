...
public class TestJSONParseByCountryActiveCases {
	...
	public TestJSONParseByCountryActiveCases() {
	...
	public String testConnection(String country) {
		try {
			...
			return JSONParseByCountryActiveCases(responseContent.toString());
	...
	public static String JSONParseByCountryActiveCases (String responseBody) {
		JSONObject obj = new JSONObject(responseBody);
		if (obj.has("country")) {
			JSONArray countryStatisticArray = (JSONArray) obj.get("latest_stat_by_country");
			
			String country_total_active_cases = countryStatisticArray.getJSONObject(0).getString("active_cases");
			System.out.println(country_total_active_cases);
			return country_total_active_cases;
		}
		return "404";
	}
	
	@Test
	public void testJSONParseByCountryActiveCases() {
