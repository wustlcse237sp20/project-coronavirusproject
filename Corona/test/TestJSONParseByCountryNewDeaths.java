...
public class TestJSONParseByCountryNewDeaths {
	...
	public TestJSONParseByCountryNewDeaths() {
	...
	public String testConnection(String country) {
		try {
			...
			return JSONParseByCountryNewDeaths(responseContent.toString());
	...
	public static String JSONParseByCountryNewDeaths (String responseBody) {
		JSONObject obj = new JSONObject(responseBody);
		if (obj.has("country")) {
			JSONArray countryStatisticArray = (JSONArray) obj.get("latest_stat_by_country");
			
			String country_total_new_deaths = countryStatisticArray.getJSONObject(0).getString("new_deaths");
			System.out.println(country_total_new_deaths);
			return country_total_new_deaths;
		}
		return "404";
	}
	
	@Test
	public void testJSONParseByCountryNewDeaths() {
		System.out.println("************************************************************");
