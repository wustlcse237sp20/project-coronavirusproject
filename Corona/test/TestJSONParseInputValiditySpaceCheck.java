...
public class TestJSONParseInputValiditySpaceCheck  {
	...
	public TestJSONParseInputValiditySpaceCheck () {
	...
	public String testConnection(String country) {
		try {
			...
			return  TestJSONParseInputValidity(responseContent.toString());
	...
	public static String TestJSONParseInputValidity  (String responseBody) {
		JSONObject obj = new JSONObject(responseBody);
		if (obj.has("country")) {
			JSONArray countryStatisticArray = (JSONArray) obj.get("latest_stat_by_country");
			
			String invalid_entry = countryStatisticArray.getJSONObject(0).getString("      ");
	...
	@Test
	public void  JSONParseInputValidityTest() {
		System.out.println("************************************************************");
