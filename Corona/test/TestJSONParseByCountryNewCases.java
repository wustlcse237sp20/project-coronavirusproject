...
public class TestJSONParseByCountryNewCases {
	...
	public TestJSONParseByCountryNewCases() {
	...
	public String testConnection(String country) {
		try {
			...
			return JSONParseByCountryNewCases(responseContent.toString());
	...
	public static String JSONParseByCountryNewCases (String responseBody) {
		JSONObject obj = new JSONObject(responseBody);
		if (obj.has("country")) {
			JSONArray countryStatisticArray = (JSONArray) obj.get("latest_stat_by_country");
			
			String country_total_new_cases = countryStatisticArray.getJSONObject(0).getString("new_cases");
			System.out.println(country_total_new_cases);
			return country_total_new_cases;
		}
		return "404";
	}
	
	@Test
	public void testJSONParseByCountryNewCases() {
		System.out.println("************************************************************");
