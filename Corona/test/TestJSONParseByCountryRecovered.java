...
public class TestJSONParseByCountryRecovered {
	...
	public TestJSONParseByCountryRecovered() {
	...
	public String testConnection(String country) {
		try {
			...
			return JSONParseByCountryRecovered(responseContent.toString());
	...
	public static String JSONParseByCountryRecovered (String responseBody) {
		JSONObject obj = new JSONObject(responseBody);
		if (obj.has("country")) {
			JSONArray countryStatisticArray = (JSONArray) obj.get("latest_stat_by_country");
			
			String country_total_recovered = countryStatisticArray.getJSONObject(0).getString("total_recovered");
			System.out.println(country_total_recovered);
	...
	@Test
	public void testJSONParseByCountryRecovered() {
		System.out.println("************************************************************");
