...
public class ConnectionFailedBecauseAPIDown {
	...
	public ConnectionFailedBecauseAPIDown () {
	...
	void testConnectionSuccess() {
		assertEquals(false, testCountryAPIConnection("Italy"));
		System.out.println("************************************************************");
		System.out.println("Description: This test will pass if API is down");
		System.out.println("Green LIGHT: API DOWN Failure");
		System.out.println("API FAILURE...TRY AGAIN LATER");
		System.out.println("************************************************************");
	}
